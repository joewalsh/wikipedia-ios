...
- (void)testRemovingHTMLRetainsMinusEntity {
    ...
    NSMutableAttributedString *displayTitleAttributedString = [displayTitle wmf_attributedStringFromHTMLWithFont:standard boldFont:nil italicFont:italic boldItalicFont:nil color:nil linkColor:nil handlingLinks:NO handlingLists:NO handlingSuperSubscripts:NO decodingEntities:YES tagMapping:nil additionalTagAttributes:nil];
